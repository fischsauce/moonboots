...
eyeTL.to(eye_inner, 3, {x:+13, ease: Power2.easeInOut});
...
glassTL.to(glass, 3, {x:+12, ease: Power2.easeInOut});
glassTL.to(glass, 3, {x:-8, ease: Power2.easeInOut});
glassTL.to(glass, 3, {x:0, ease: Power2.easeInOut});
